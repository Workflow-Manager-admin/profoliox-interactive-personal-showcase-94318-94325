...
// PUBLIC_INTERFACE
/**
 * Footer component for the ProfolioX portfolio application.
    ...
    <footer className="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="flex flex-wrap justify-center -mx-5 -my-2">
          ...
          <div className="px-5 py-2">
            <Link href="/projects" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
              Projects
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/skills" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
              Skills
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/experience" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">
              Experience
            </Link>
          </div>
          <div className="px-5 py-2">
        ...
        <p className="mt-8 text-center text-base text-gray-500 dark:text-gray-400">
          &copy; {currentYear} ProfolioX. All rights reserved.
        </p>
      </div>
    </footer>
  );
